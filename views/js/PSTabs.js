...
/******/ 	return __webpack_require__(__webpack_require__.s = "./_dev/js/PSTabs.js");
/******/ })
/************************************************************************/
/******/ ({
...
(function (window) {
  ...
  PSTabs.prototype._init = function () {
    ...
    // get current index
    this.index = Number(document.URL.substring(_babel_runtime_corejs3_core_js_stable_instance_index_of__WEBPACK_IMPORTED_MODULE_3___default()(_context = document.URL).call(_context, "#stripe_step_") + 13)); // tabs elems

    this.tabs = _babel_runtime_corejs3_core_js_stable_instance_slice__WEBPACK_IMPORTED_MODULE_2___default()([]).call(this.el.querySelectorAll('nav > a')); // content items

    this.items = _babel_runtime_corejs3_core_js_stable_instance_slice__WEBPACK_IMPORTED_MODULE_2___default()([]).call(this.el.querySelectorAll('.content-wrap > section')); // set current

    this.current = -1; // current index

    this.options.start = this.index != NaN ? Number(this.index) - 1 : 0; // show current content item
  ...
  PSTabs.prototype._initEvents = function () {
    ...
    _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_1___default()(_context2 = this.tabs).call(_context2, function (tab, idx) {
...
/******/ });
//# sourceMappingURL=PSTabs.js.map