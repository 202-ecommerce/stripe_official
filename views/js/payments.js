...
/******/ 	return __webpack_require__(__webpack_require__.s = "./_dev/js/payments.js");
/******/ })
/************************************************************************/
/******/ ({
...
$(function () {
  ...
  /*#__PURE__*/
  function () {
    var _ref = _babel_runtime_corejs3_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_9___default()(
    /*#__PURE__*/
    _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_7___default.a.mark(function _callee4() {
      'use strict'; // Create references to the submit button.

      var $submit, $submitButtons, submitInitialText, payment, disableText, paymentIntent, stripe, elements, style, card, paymentRequest, prButton, iban, idealBank, handlePayment, handleSourceActivation, pollPaymentIntentStatus, _pollPaymentIntentStatus, updateError, disableSubmit, enableSubmit;

      return _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_7___default.a.wrap(function _callee4$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              enableSubmit = function _ref15(element) {
                $(element).prop('disabled', false);
                $(element).text(submitInitialText);
              };

              disableSubmit = function _ref14(element, text) {
                $(element).prop('disabled', true);
                $(element).text(text ? text : submitInitialText);
              };

              updateError = function _ref13(element, error) {
                var $error = $(".stripe-payment-form:visible .stripe-error-message");
              ...
              _pollPaymentIntentStatus = function _ref12() {
                _pollPaymentIntentStatus = _babel_runtime_corejs3_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_9___default()(
                /*#__PURE__*/
                _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_7___default.a.mark(function _callee3() {
                  var endStates, response;
                  return _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_7___default.a.wrap(function _callee3$(_context5) {
                    while (1) {
                      switch (_context5.prev = _context5.next) {
                        case 0:
                          endStates = ['succeeded', 'processing', 'canceled']; // Retrieve the PaymentIntent status from our server.

                          _context5.next = 3;
                          return stripe.retrievePaymentIntent(stripe_client_secret);

                        case 3:
                          response = _context5.sent;
                          console.log(response.paymentIntent.status);

                          if (!_babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_4___default()(endStates).call(endStates, response.paymentIntent.status)) {
                            _babel_runtime_corejs3_core_js_stable_set_timeout__WEBPACK_IMPORTED_MODULE_3___default()(pollPaymentIntentStatus, 1000); // Every second
                ...
                return _pollPaymentIntentStatus.apply(this, arguments);
              };

              pollPaymentIntentStatus = function _ref11() {
                return _pollPaymentIntentStatus.apply(this, arguments);
              };

              handleSourceActivation = function _ref10(source, element) {
                ...
                switch (source.flow) {
                  case 'none':
                    ...
                    if (source.type === 'wechat') {
                      // Display the QR code.
                      var qrCode = new QRCode('stripe-wechat-qrcode', {
                      ...
                      $(".stripe-wechat-after").show(); // Start polling the PaymentIntent status.
                  ...
                  case 'receiver':
                    ...
                    var receiverInfo = confirmationElement.querySelector('.receiver .info');
                    var amount = store.formatPrice(source.amount, stripe_currency);

                    switch (source.type) {
                      case 'multibanco':
                        // Display the Multibanco payment information to the user.
                        var multibanco = source.multibanco;
                        receiverInfo.innerHTML = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_5___default()(_context3 = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_5___default()(_context4 = "\n            <ul>\n            <li>Amount (Montante): <strong>".concat(amount, "</strong></li>\n            <li>Entity (Entidade): <strong>")).call(_context4, multibanco.entity, "</strong></li>\n            <li>Reference (Referencia): <strong>")).call(_context3, multibanco.reference, "</strong></li>\n            </ul>");
                        break;
              ...
              handlePayment = function _ref9(response) {
                if (response.error) {
              ...
              $submit = $('#payment-confirmation button[type="submit"], .stripe-europe-payments[data-method="bancontact"], .ideal-submit-button[data-method="ideal"], .stripe-europe-payments[data-method="giropay"], .stripe-europe-payments[data-method="sofort"], .stripe-submit-button');
              $submitButtons = $('#payment-confirmation button[type="submit"], .stripe-submit-button');
              submitInitialText = $submitButtons.text();
              $form = $('#stripe-card-payment');
              payment = '';
              disableText = ''; // Global variable to store the PaymentIntent object.
              ...
              */
              ...
              style = JSON.parse(stripe_css); // Create a Card Element and pass some custom styles to it.
              ...
              card.mount('#stripe-card-element'); // Monitor change events on the Card Element to display any errors.
              ...
              /*#__PURE__*/
              function () {
                var _ref3 = _babel_runtime_corejs3_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_9___default()(
                /*#__PURE__*/
                _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_7___default.a.mark(function _callee(event) {
                  ...
                  return _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_7___default.a.wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          _context.next = 2;
                          return stripe.confirmPaymentIntent(stripe_client_secret, {
                        ...
                        case 8:
                          ...
                          $submit.attr('disabled', 'disabled'); // Let Stripe.js handle the rest of the payment flow, including 3D Secure if needed.

                          _context.next = 12;
                          return stripe.handleCardPayment(stripe_client_secret);
            ...
            case 27:
              ...
              prButton.mount('#stripe-payment-request-button'); // TODO: show additional instructions
            ...
            case 33:
              if ($("#stripe-iban-element").length) {
                ...
                iban.mount('#stripe-iban-element'); // Monitor change events on the IBAN Element to display any errors.

                iban.on('change', function (_ref5) {
                  var error = _ref5.error,
                      bankName = _ref5.bankName;
                  updateError($submitButtons, error);
                });
              ...
              if ($("#stripe-ideal-bank-element").length) {
                idealBank = elements.create('idealBank', {
                  style: {
                    base: _babel_runtime_corejs3_core_js_stable_object_assign__WEBPACK_IMPORTED_MODULE_6___default()({
                      padding: '10px 15px'
                    }, style.base)
                  }
              ...
              */
              ...
              /*#__PURE__*/
              function () {
                var _ref6 = _babel_runtime_corejs3_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_9___default()(
                /*#__PURE__*/
                _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_7___default.a.mark(function _callee2(event) {
                  var response, _response, sourceData, _ref7, _source, _ref8, source;

                  return _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_7___default.a.wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        ...
                        case 2:
                          event.preventDefault(); // Retrieve the payment method.
                          ...
                          _context2.next = 8;
                          return stripe.handleCardPayment(stripe_client_secret, card, {
                            source_data: {
                              owner: {
                        ...
                        case 12:
                          ...
                          _context2.next = 15;
                          return stripe.confirmPaymentIntent(stripe_client_secret, iban, {
                            source_data: {
                              type: 'sepa_debit',
                              owner: {
                                name: stripe_fullname,
                        ...
                        case 19:
                          ...
                          _context2.t0 = payment;
                          _context2.next = _context2.t0 === 'ideal' ? 23 : _context2.t0 === 'sofort' ? 30 : 32;
                          break;

                        case 23:
                          _context2.next = 25;
                          return stripe.createSource(idealBank, sourceData);

                        case 25:
                          _ref7 = _context2.sent;
                          _source = _ref7.source;
                          handleSourceActivation(_source, $form);
  ...
  var observer = new MutationObserver(function (mutations) {
    $.each(mutations, function (i, mutation) {
      ...
      var selector = '#stripe-card-payment';

      var filteredEls = _babel_runtime_corejs3_core_js_stable_instance_find__WEBPACK_IMPORTED_MODULE_2___default()(addedNodes).call(addedNodes, selector).addBack(selector);
